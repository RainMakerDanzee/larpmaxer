...
(role family, location, "last 24 hours"). Read the workspace `AGENTS.md` first if it has not loaded
this session.

## Steps

1. **Search where the ads are** — job boards via the browser and web
